...
Feature: Ordem de Ativacao
	...
	Scenario Outline: Consulta de viabilidade IdGpon Valido 
       # Enviar uma consulta de viabilidade IDGPON (válido) + IdEndereco (válido) + Endereço completo (válido)
		Given Eu valido idGpon "<idGponValid>" idEndereco "<idEnderecoValid>" UF "<UFValid>" codigoLocalidade "<codigoLocalidadeValid>" codigoLogradouro "<codigoLogradouroValid>" nFachada "<nFachadaValid>"
