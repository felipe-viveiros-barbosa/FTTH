...
Feature: Ordem de Ativacao
	...
	Scenario Outline: Criacao da Ordem
		...
		Then Faco uma ativacao nova fibra
			| CFS.HSI | CFS.IPTV | CFS.RFTV | CFS.VOIP |
			|<CFS.HSI>|<CFS.IPTV>|<CFS.RFTV>|<CFS.VOIP>|
		 And Eu consulto o GPON criado
		 #And Eu consulto os servicos criados
		 
		 And I make a service GPON query teste nova fibra

		 And I validate nova fibra "NETQ" data from "CFS.ACESSOGPON" query at "om"
		 And I validate nova fibra "NETQ" data from "CFS.IPTV" query at "om"
		And I validate nova fibra "NETQ" data from "CFS.HSI" query at "om"
		And I validate nova fibra "NETQ" data from "CFS.VOIP" query at "om"
		And I validate nova fibra "OM" data from "CFS.ACESSOGPON" query at "om"
		And I validate nova fibra "OM" data from "CFS.IPTV" query at "om"
		And I validate nova fibra "OM" data from "CFS.HSI" query at "om"
		And I validate nova fibra "OM" data from "CFS.VOIP" query at "om"
		...
		And I make the order update CPE nova fibra
		And I make the order update CR
		And I finish the order
 
		And I validate physical inventory nova fibra
		

		And I validate nova fibra "NETQ" data from "CFS.ACESSOGPON" query at "inventory"
		And I validate nova fibra "NETQ" data from "CFS.IPTV" query at "inventory"
		And I validate nova fibra "NETQ" data from "CFS.HSI" query at "inventory"
		And I validate nova fibra "NETQ" data from "CFS.VOIP" query at "inventory"
		And I validate nova fibra "OM" data from "CFS.ACESSOGPON" query at "inventory"
		And I validate nova fibra "OM" data from "CFS.IPTV" query at "inventory"
		And I validate nova fibra "OM" data from "CFS.HSI" query at "inventory"
		And I validate nova fibra "OM" data from "CFS.VOIP" query at "inventory"
	...
	Examples:
		...
		|           |         |         |        |         |         | VELOC_50MBPS | PCT_CANAL_IPTV | PCT_CANeu tenhAL_RF_RF | OIVOIP_ILIMITADO |
